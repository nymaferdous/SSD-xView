...
SSD_PRESETS = {
    'vgg300': SSDPreset(name = 'vgg300',
                        ...
                        maps = [
                            SSDMap(Size(76, 76), 0.02,   [2, 0.5]),
                            SSDMap(Size(38, 38), 0.03,   [2, 0.5]),
                            SSDMap(Size(19, 19), 0.05,   [2, 3, 0.5, 1./3.]),
                            SSDMap(Size(10, 10), 0.07, [2, 3, 0.5, 1./3.]),
                            SSDMap(Size( 5,  5), 0.09,  [2, 3, 0.5, 1./3.]),
                            SSDMap(Size( 3,  3), 0.1, [2, 0.5]),
                            SSDMap(Size( 1,  1), 0.3,   [2, 0.5])
                        ],
                        extra_scale = 107.5,
                        num_anchors = 31836),
    'vgg512': SSDPreset(name = 'vgg512',
                        ...
                        maps = [
                            SSDMap(Size(128, 128), 0.02, [2, 0.5]),
                            SSDMap(Size(64, 64), 0.03, [2, 0.5]),
                            SSDMap(Size(32, 32), 0.05, [2, 3, 0.5, 1./3.]),
                            SSDMap(Size(16, 16), 0.07,  [2, 3, 0.5, 1./3.]),
                            SSDMap(Size( 8,  8), 0.09, [2, 3, 0.5, 1./3.]),
                            SSDMap(Size( 4,  4), 0.1,  [2, 3, 0.5, 1./3.]),
                            SSDMap(Size( 2,  2), 0.3, [2, 0.5]),
...
#-------------------------------------------------------------------------------
def decode_boxes(pred, anchors, confidence_threshold = 0.02, lid2name = {},
                 detections_cap=200):
    """
